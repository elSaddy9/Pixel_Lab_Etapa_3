...
func _on_AreaDisparo_body_exited(body: Node) -> void:
	controlador_estados_ia(ESTADO_IA.PERSECUCION) # Replace with function body.


# warning-ignore:unused_argument
func _on_AreaVision_body_entered(body: Node) -> void:
	controlador_estados_ia(ESTADO_IA.ATACANDOQ) # Replace with function body.


# warning-ignore:unused_argument
func _on_AreaVision_body_exited(body: Node) -> void:
	controlador_estados_ia(ESTADO_IA.PERSECUCION) # Replace with function body.
