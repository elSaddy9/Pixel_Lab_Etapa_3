...
onready var info_laser:ContenedorInfoEnergia = $InfoLaser
onready var info_escudo:ContenedorInfoEnergia = $InfoEnergiaEscudo
...
func _actualizar_energi_laser(energia_max:float, energia_actual:float)->void:
	info_laser.mostrar()
